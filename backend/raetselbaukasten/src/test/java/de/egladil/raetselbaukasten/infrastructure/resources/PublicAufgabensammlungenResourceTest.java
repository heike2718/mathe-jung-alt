...
public class PublicAufgabensammlungenResourceTest {
    ...
    void testFindAufgabensammlungenWithoutSuchparameters() throws Exception {
...

        {
            ...
            Optional<AufgabensammlungSucheTrefferItem> optItem = treffer
                    .getItems()
                    .stream()
                    .filter(i -> "581cbd35-9423-414f-bda5-3eb2d05b979b".equals(i.getId()))
                    .findFirst();
        ...
        List<AufgabensammlungSucheTrefferItem> itemsFreigegeben = treffer
                .getItems()
                .stream()
                .filter(i -> !"581cbd35-9423-414f-bda5-3eb2d05b979b".equals(i.getId()))
                .toList();
    ...
    void testLoadDetails403() throws Exception {
        ...
        given().get(id + "/v1").then().statusCode(403);
    }
    ...
    void test_printVorschau_403() {
        ...
        given()
                ...
                .get("c09e5d63-9ec1-4884-a01e-08234db9cbf3/vorschau/v1")
                .then()
                .statusCode(403);
    }
    ...
    void test_downloadLaTeX_403() {
        ...
        given()
                ...
                .get("c09e5d63-9ec1-4884-a01e-08234db9cbf3/latex/v1")
                .then()
                .statusCode(403);
    }
    ...
    void test_printArbeitsblatt_when_QuelleWithInternet() {
        ...
        given()
                .queryParam("layoutAntwortvorschlaege", "BUCHSTABEN")
                .accept(ContentType.JSON)
                .get("f2e390b1-0425-4095-b594-9ab91d2ac606/arbeitsblatt/v1")
                .then()
                .statusCode(200);
