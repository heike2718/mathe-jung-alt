...
public class AufgabensammlungenResourceAuthorizationTest {
    ...
    void testFindAufgabensammlungenUnauthorized() throws Exception {
        ...
        given()
                ...
                .get("v1?limit=20&offset=0&referenz=2022&referenztyp=MINIKAENGURU&schwierigkeitsgrad=EINS&sortAttribute=name&sortDirection=asc")
                .then()
                .statusCode(401);
    }
    ...
    void testLoadDetailsForbidden() throws Exception {
        ...
        given().contentType(ContentType.JSON).get(id + "/v1").then().assertThat().statusCode(403);
    }
    ...
    void test_printVorschauUnauthorized() {
        ...
        given()
                ...
                .get("10257506-71c5-423e-b355-bf90b5bb344d/vorschau/v1?layoutAntwortvorschlaege=BUCHSTABEN")
                .then()
                .statusCode(401);
    }
    ...
    void test_printArbeitsblattMitLoesungenUnauthorized() {
        ...
        given()
                ...
                .cookie(AuthConstants.CSRF_TOKEN_COOKIE_NAME, CSRF_TOKEN)
                .accept(ContentType.JSON)
                .get("10257506-71c5-423e-b355-bf90b5bb344d/arbeitsblatt/v1?layoutAntwortvorschlaege=BUCHSTABEN")
                .then()
                .statusCode(401);
    }
    ...
    void test_printKnobelkarteiUnauthorized() {
        ...
        given()
                ...
                .cookie(AuthConstants.CSRF_TOKEN_COOKIE_NAME, CSRF_TOKEN)
                .accept(ContentType.JSON)
                .get("10257506-71c5-423e-b355-bf90b5bb344d/knobelkartei/v1?layoutAntwortvorschlaege=BUCHSTABEN")
                .then()
                .statusCode(401);
    }
