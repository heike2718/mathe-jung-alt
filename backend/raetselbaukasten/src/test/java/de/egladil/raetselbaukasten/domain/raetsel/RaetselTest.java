...
public class RaetselTest {
    ...
    void serialize() throws JsonProcessingException {
        ...
        Raetsel raetsel = new Raetsel("df5d4136-8fa6-4fac-b566-470ff7c3c869")
                .withAntwortvorschlaege(antwortvorschlage)
                .withDeskriptoren(deskriptoren)
                .withFrage("Wie viele Meter sind es bis zur Schule?")
                .withKommentar("Minikänguru 2021")
                .withSchluessel("02565")
                .withName("Schulweglänge")
                .withFilenameVorschauFrage("2b9afae0-58b9.png")
