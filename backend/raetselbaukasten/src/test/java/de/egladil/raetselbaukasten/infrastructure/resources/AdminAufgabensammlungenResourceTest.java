...
public class AdminAufgabensammlungenResourceTest {
    ...
    void elementAnlegenAendernLoeschen() throws Exception {
...

        {
            ...
            Optional<Aufgabensammlungselement> optNeu = elemente
                    .stream()
                    .filter(el -> "02618".equals(el.getRaetselSchluessel()))
                    .findFirst();
...

        {
            ...
            if (elementUuid != null) {
                ...
                assertEquals(13, elemente.size());
                Optional<Aufgabensammlungselement> opt = elemente
                        .stream()
                        .filter(el -> "02618".equals(el.getRaetselSchluessel()))
                        .findFirst();
    ...
    void elementAnlegenRaetselSchonEnthalten() throws Exception {
        ...
        assertEquals("Das Rätsel gibt es in dieser Aufgabensammlung schon.", messagePayload.getMessage());
    }
    ...
    void elementAendernElementExistiertNicht() throws Exception {
        ...
        assertEquals("Tja, dieses Element gibt es gar nicht.", messagePayload.getMessage());
    ...
    void test_downloadLaTeX() {
        ...
        given()
                ...
                .get("10257506-71c5-423e-b355-bf90b5bb344d/latex/v1")
                .then()
                .statusCode(200);
    }
    ...
    void test_downloadLaTeXKeinTreffer() {
        ...
        given()
                ...
                .queryParam("layoutAntwortvorschlaege", "BUCHSTABEN")
                .accept(APPLICATION_OCTET_STREAM)
                .get("33333333-71c5-423e-b355-bf90b5bb344d/latex/v1")
                .then()
                .statusCode(404);
    }
    ...
    void test_printVorschau() {
        ...
        given()
                ...
                .get("10257506-71c5-423e-b355-bf90b5bb344d/vorschau/v1")
                .then()
                .statusCode(200);
    }
    ...
    void test_printVorschauKeinTreffer() {
        ...
        given()
                ...
                .contentType(ContentType.JSON)
                .accept(ContentType.JSON)
                .get("33333333-71c5-423e-b355-bf90b5bb344d/vorschau/v1?layoutAntwortvorschlaege=BUCHSTABEN")
                .then()
                .statusCode(404);
    }
    ...
    void test_printArbeitsblattMitLoesungen() {
        ...
        given()
                ...
                .queryParam("size", "LARGE")
                .accept(ContentType.JSON)
                .get("10257506-71c5-423e-b355-bf90b5bb344d/arbeitsblatt/v1")
                .then()
                .statusCode(200);
    }
    ...
    void test_printKnobelkartei() {
        ...
        given()
                ...
                .queryParam("size", "LARGE")
                .accept(ContentType.JSON)
                .get("10257506-71c5-423e-b355-bf90b5bb344d/knobelkartei/v1")
                .then()
                .statusCode(200);
    }
