...
@NamedQueries({ @NamedQuery(name = "Deskriptor.LIST_ALL", query = "select d from Deskriptor d order by d.id") })
@Schema(name = "Deskriptor", description = "Deskriptor-Entity mit allen Attributen.")
