...
import de.egladil.raetselbaukasten.domain.semantik.ValueObject;
...
public class Antwortvorschlag {
    ...
    @Pattern(
            regexp = MjaRegexps.VALID_ANTWORTVORSCHLAGTEXT,
            message = "Der Text des Antwortvorschlags enthält ungültige Zeichen")
    private String text;
