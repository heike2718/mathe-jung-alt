...
import de.egladil.raetselbaukasten.domain.aufgabensammlungen.AufgabensammlungenSortattribute;
...
import de.egladil.raetselbaukasten.domain.aufgabensammlungen.dto.AufgabensammlungDetails;
import de.egladil.raetselbaukasten.domain.aufgabensammlungen.dto.AufgabensammlungSucheTreffer;
import de.egladil.raetselbaukasten.domain.aufgabensammlungen.dto.AufgabensammlungSucheTrefferItem;
import de.egladil.raetselbaukasten.domain.aufgabensammlungen.dto.EditAufgabensammlungPayload;
import de.egladil.raetselbaukasten.domain.aufgabensammlungen.dto.EditAufgabensammlungselementPayload;
...
public class AufgabensammlungenResource {
	...
	// @formatter:on
        ...
        return aufgabensammlungenService
                .printVorschau(aufgabensammlungID, theFont, theSchriftgroesse, layoutAntwortvorschlaege);
    }
    ...
    @APIResponse(
            ...
            responseCode = "200",
            content = @Content(mediaType = "application/octet-stram"))
    @APIResponse(
            name = "Unauthorized",
   ...
   // @formatter:on
        ...
        File generatedFile = aufgabensammlungenService
                .downloadLaTeXSources(aufgabensammlungID, theFont, theSchriftgroesse, layoutAntwortvorschlaege);
	...
	// @formatter:on
        ...
        return aufgabensammlungenService
                .printArbeitsblattMitLoesungen(aufgabensammlungID, theFont, theSchriftgroesse, theLayout);
    }
	...
	// @formatter:on
        ...
        LOGGER
                .debug("font={}, theFont={}, size={}, theSize={}, theLayout={}", font, theFont, schriftgroesse,
                        theSchriftgroesse, theLayout);
