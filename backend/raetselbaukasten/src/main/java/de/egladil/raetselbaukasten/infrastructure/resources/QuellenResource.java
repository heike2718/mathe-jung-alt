...
public class QuellenResource {
    ...
    @APIResponse(
            name = "OKResponse",
            responseCode = "200",
            content = @Content(mediaType = "application/json", schema = @Schema(implementation = QuelleDto.class)))
    @APIResponse(name = "Unauthorized", description = "nicht authentifiziert", responseCode = "401")
    @APIResponse(name = "Forbidden", description = "nicht autorisiert", responseCode = "403")
    @APIResponse(
            name = "NotFound",
