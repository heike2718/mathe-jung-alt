...
public class InitSecurityContextFilter implements ContainerRequestFilter {
	...
	private static List<String> OPEN_DATA_PATHS = Arrays.asList(new String[] { "/api/public", "/api/restricted",
		"/api/session/logout", "/api/session/authurls/login", "/api/session/login", "/api/session/authurls/signup", "/api/about" });
