...
public class RaetselResource {
    ...
    @Parameters({ @Parameter(
            ...
            @Parameter(
                    in = ParameterIn.QUERY,
                    name = "searchModeForDescriptors",
                    description = "SQL-Operator mit dem nach Deskriptoren gesucht wird."),
            @Parameter(
                    in = ParameterIn.QUERY,
                    name = "typeDeskriptoren",
                    description = "wie die Deskriptoren gesendet: die technischen IDs oder die Namen.",
                    required = true),
    ...
    @Parameters({
            @Parameter(in = ParameterIn.PATH, name = "schluessel", description = "fachlicher Schlüssel des Rätsels") })
    @APIResponse(
            name = "OKResponse",
            responseCode = "200",
            content = @Content(mediaType = "application/json", schema = @Schema(implementation = Raetsel.class)))
    @APIResponse(
            name = "NotFound",
    ...
    public Response raetselDetailsLaden(
            ...
            @PathParam(value = "schluessel") final String schluessel) {
    ...
    @APIResponse(
            name = "OKResponse",
            responseCode = "200",
            content = @Content(mediaType = "application/json", schema = @Schema(implementation = Images.class)))
    @APIResponse(
            name = "ServerError",
            description = "server error",
            responseCode = "500",
	...
	// @formatter:on
        ...
        Images result = generatorService
                .generatePNGsRaetsel(raetselUuid, layoutAntwortvorschlaege, font, schriftgroesse);

        // jetzt liegt schluessel.png und evtl. schluessel_l.png im latex.base.dir und
    ...
    @APIResponse(
            name = "OKResponse",
            responseCode = "200",
            content = @Content(mediaType = "application/json", schema = @Schema(implementation = GeneratedFile.class)))
    @APIResponse(name = "Forbidden", responseCode = "403", content = @Content(mediaType = "application/json"))
    @APIResponse(
            name = "NotFoundResponse",
            responseCode = "404",
	...
	// @formatter:on
        ...
        GeneratedFile result = generatorService
                .generatePDFRaetsel(raetselUuid, layoutAntwortvorschlaege, font, schriftgroesse);
        return Response.ok(result).build();
    }
    ...
    public Response downloadEmbeddedImages(
            ...
            @PathParam(value = "raetselId") final String raetselId) {
    ...
    @APIResponse(
            ...
            content = @Content(
                    ...
                    schema = @Schema(
                            ...
                            implementation = AufgabensammlungRaetselsucheTrefferItem.class)))
    @APIResponse(name = "BadRequestResponse", responseCode = "400", description = "fehlgeschlagene Input-Validierung")
    @APIResponse(name = "NotAuthorized", responseCode = "401", content = @Content(mediaType = "application/json"))
    @APIResponse(
            name = "ServerError",
