...
public class MediumDao {
    ...
    public int getMaximumOfAllSortNumbers() {
        ...
        List<Long> trefferliste = entityManager
                .createNamedQuery(PersistentesMedium.MAX_SORTNR, Long.class)
                .getResultList();
    ...
    public long countAllMedien() {
        ...
        List<Long> treffermenge = entityManager
                .createNamedQuery(PersistentesMedium.COUNT_ALL, Long.class)
                .getResultList();
    ...
    /**
     * Suche nach Medien, bei denen unabhängig von Groß- Kleinschreibung der titel
     * oder der Kommentar den suchstring enthält.
     *
     * @param suchstring
     * @return long
     */
    public long countAllMedienWithSuchstring(final String suchstring) {
        ...
        List<Long> treffermenge = entityManager
                .createNamedQuery(PersistentesMedium.COUNT_WITH_SUCHSTRING, Long.class)
    ...
    /**
     * Zählt alle Medien mit dem Titel titel aber einer anderen UUID als die
     * gegebene medienId. Falls > 0 würde das uk zuschlagen.
     *
     * @param titel    String es wird auf Gleichheit geprüft
     * @param mediumId es wird auf Ungleichheit geprüft
     * @return long
     */
    public long countMedienWithSameTitel(final String titel, final String mediumId) {

        List<Long> treffermenge = entityManager
                .createNamedQuery(PersistentesMedium.ANZAHL_MIT_TITEL_GLEICH, Long.class)
    ...
    public List<PersistentesMedium> loadAllMedien(final int limit, final int offset) {
        ...
        return entityManager
                .createNamedQuery(PersistentesMedium.LOAD_ALL, PersistentesMedium.class)
    ...
    /**
     * Suche nach Medien, bei denen unabhängig von Groß- Kleinschreibung der titel
     * oder der Kommentar den suchstring enthält. Sortiert wird nach titel.
     *
     * @param suchstring
     * @param limit
     * @param offset
     * @return List
     */
    public List<PersistentesMedium> findAllMedienWithSuchstring(final String suchstring, final int limit,
            final int offset) {

        String theSuchstring = "%" + suchstring + "%";

        return entityManager
                .createNamedQuery(PersistentesMedium.FIND_WITH_SUCHSTRING, PersistentesMedium.class)
                .setParameter("suchstring", theSuchstring)
                .setFirstResult(offset)
                .setMaxResults(limit)
                .getResultList();
    ...
    public List<PersistentesMedium> findWithMedienart(final Medienart medienart) {
        ...
        return entityManager
                .createNamedQuery(PersistentesMedium.FIND_WITH_MEDIENART, PersistentesMedium.class)
