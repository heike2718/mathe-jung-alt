...
import de.egladil.raetselbaukasten.domain.generatoren.impl.AntwortvorschlagGeneratorStrategegy;
import de.egladil.raetselbaukasten.domain.generatoren.impl.GeneratorFontsDelegate;
import de.egladil.raetselbaukasten.domain.generatoren.impl.LaTeXPlaceholder;
import de.egladil.raetselbaukasten.domain.generatoren.impl.LaTeXTemplatesService;
import de.egladil.raetselbaukasten.domain.generatoren.impl.LoesungsbuchstabeTextGenerator;
...
import de.egladil.raetselbaukasten.domain.raetsel.dto.ImageFormat;
import de.egladil.raetselbaukasten.domain.raetsel.dto.Images;
import de.egladil.raetselbaukasten.domain.raetsel.dto.MjaImage;
import de.egladil.raetselbaukasten.domain.raetsel.dto.Rectangle;
...
public class RaetselFileService {
    ...
    /**
     * Schreibt die Frage des gegebenen Raetsels in ein LaTeX-File im Filesystem und
     * gibt den Pfad des File zurück. Der Name des Files ist der Schlüssel des
     * Raetsels.
     *
     * @param raetsel                  Raetsel
     * @param layoutAntwortvorschlaege LayoutAntwortvorschlaege
     * @param font                     FontName in welchem font generiert werden
     *                                 soll.
    ...
    public String generateFrageLaTeX(final Raetsel raetsel, final LayoutAntwortvorschlaege layoutAntwortvorschlaege,
        ...
        LayoutAntwortvorschlaege theResultingLayout = raetsel.isAntwortvorschlaegeEingebettet()
                ? LayoutAntwortvorschlaege.NOOP : layoutAntwortvorschlaege;

        String antworten = AntwortvorschlagGeneratorStrategegy
                .create(theResultingLayout)
        ...
        template = template
                .replace(LaTeXPlaceholder.SCHRIFTGROESSE.placeholder(), schriftgroesse.getLaTeXReplacement());
    ...
    /**
     * Schreibt die Lösung des gegebenen Raetsels in ein LaTeX-File im Filesystem
     * und gibt den Pfad des Files zurück. Der Name des Files ist der Schlüssel des
     * Raetsels mit angehängtem _l.
     *
     * @param raetsel
     * @param font           FontName in welchem font generiert werden soll.
     * @param schriftgroesse Schriftgroesse
     * @return String Pfad des LaTeX-Files.
     */
    ...
    /**
     * Generiert das LaTeX für die PDF-Vorschau des gegebenen Raetsels, speichert es
     * als LaTeX-File im Filessystem und gibt den Pfad des Files zurück.
     *
     * @param raetsel                  Der Name des Files ist der Schlüssel des
     *                                 Raetsels mit angehängtem _x.
     * @param layoutAntwortvorschlaege LayoutAntwortvorschlaege
     * @param font                     FontName in welchem font generiert werden
     *                                 soll.
     * @param schriftgroesse           Schriftgroesse
     * @return String
     */
    public String generiereLaTeXRaetselPDF(final Raetsel raetsel,
        ...
        boolean printAsMultipleChoice = GeneratorUtils.shouldPrintAntwortvorschlaege(layoutAntwortvorschlaege, input);

        String textRaetsel = new QuizitemLaTeXGenerator()
                .generateLaTeXFrageLoesung(input, TrennerartFrageLoesung.ABSTAND, printAsMultipleChoice);
    ...
    public MjaImage findVorschau(final String filename) {
        ...
        return new MjaImage()
                .withData(data)
                .withWidth(dimensions.getWidth())
                .withHeight(dimensions.getHeight())
                .withFormat(imageFormat.getFormatStringForResponse());
    }

    /**
     * Nach dem generieren der PNGs liegen diese im latex.base.dir (Namen
     * schluessel.png bzw. schluessel_l.png). Diese Methode verschiebt die
     * generierten PNGs in das entsprechende Unterverzeichnis.
     *
     * @param raetsel Raetsel
     */
    ...
    /**
     * Schaut, ob die Images für Frage und Lösung bereits da sind und verpackt sie
     * in ein Objekt.
     *
     * @param filenameFrage   String
     * @param filenameLoesung String
     * @return
     */
    ...
    /**
     * Falls es schluessel.log oder schluessel_l.log gibt, werden sie in das Array
     * verpackt zum Downloaden.
     *
     * @param schluessel
     * @return
     */
     ...
     *
     * @param filenames String oder String[]
     */
     ...
     *
     * @param relativePath String Pfad relativ zum latex.base.dir
     */
