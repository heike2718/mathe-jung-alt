...
public class ImageGeneratorService {
    ...
    /**
     * Erzeugt eine LaTeX-Datei mit dem MjaImage, compiliert sie zu einem png und
     * gibt das png als byte-Array zurück.
     *
     * @param relativerPfad String
     * @return byte[] ein png
     */
    ...
    private void writeOutput(final String relativerPfad, final File file, final String template) {
        ...
        String errorMessage = "konnte kein LaTex-File schreiben EmbeddableImageVorschau: [relativerPfad="
                + relativerPfad + "]";
