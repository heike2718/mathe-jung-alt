    ...
    public Response toResponse(final Throwable exception) {
        ...
        if (exception instanceof WebApplicationException) {
            ...
            if (ex.getResponse().getStatus() == 403) {
                ...
                LOGGER
                        .warn("403: könnte auch eine fehlende mod-security-Konfiguration sein, wenn es ein PUT oder DELETE-Request war");
        ...
        return Response
                .status(500)
                .entity(MessagePayload.error(applicationMessages.getString("general.internalServerError")))
                .build();
    }
