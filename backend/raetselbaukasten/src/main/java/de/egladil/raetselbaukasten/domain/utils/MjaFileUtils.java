...
public class MjaFileUtils {
    ...
    public static void writeBinaryFile(final File file, final byte[] data) {
        ...
        try (FileOutputStream fos = new FileOutputStream(file); InputStream in = new ByteArrayInputStream(data)) {
    ...
    public static void copyFiles(final List<File> files, final File targetDir) {
        ...
        for (File file : files) {
            ...
            try {
                ...
                String message = "IOException beim Kopieren von " + file.getName() + " nach "
        ...
        if (source.isFile() && source.canRead()) {
            ...
            try {
                ...
                if (target.exists()) {
                    ...
                    // FileUtils.moveFile(source, target, StandardCopyOption.REPLACE_EXISTING,
    ...
    /**
     * @param classpathLocation String
     * @return String
     */
     ...
     *
     * @param path
     * @param isTemporaryFile boolean, wenn true, dann wird es anschließend
     *                        gelöscht.
