...
public class MinikaenguruService {
    ...
    /**
     * Gibt die Aufgaben der Klassenstufe eines noch nicht freigegebenen Wettbewerbs
     * zurück.
     *
     * @param jahr
     * @param schwierigkeitsgrad
     * @return MinikaenguruAufgabenKlassenstufeDto
     * @throws WebApplicationException wenn der schwierigkeitsgrad nicht korrekt
     *                                 ist, der statusWettbewerb nicht korrekt ist
     *                                 oder bei anderen Exceptions.
     */
    ...
    MinikaenguruAufgabe mapToMinikaenguruAufgabe(final Quizaufgabe quizaufgabe) {
        ...
        return new MinikaenguruAufgabe()
                .withImages(quizaufgabe.getImages())
    ...
    /**
     * Gibt die Aufgaben der Klassenstufe eines bereits freigegebenen Wettbewerbs
     * zurück.
     *
     * @param jahr
     * @param schwierigkeitsgrad
     * @return MinikaenguruAufgabenKlassenstufeDto
     * @throws WebApplicationException wenn irgendwas ist (schwoerigkeitsgrad
     *                                 falsch, kein Wettbewerb zum angegebenen Jahr,
     *                                 noch nicht freigegeben oder andere Dinge
     */
    public MinikaenguruAufgabenKlassenstufeDto getAufgabenFreigegebenerWettbewerb(final String jahr,
        ...
        if (aufgabensammlung == null || !aufgabensammlung.isFreigegeben()) {
            ...
            LOGGER
                    .warn("Zugriffsversuch auf Aufgaben eines nicht freigegebenen Minikaenguru-Wettbewerbs: {}, {}",
                            jahr, schwierigkeitsgrad);
    ...
    private void checkSchwierigkeitsgrad(final Schwierigkeitsgrad schwierigkeitsgrad) {
        ...
        if (!schwierigkeitsgrad.isValidForMinikaenguruResources()) {
            ...
            MessagePayload messagePayload = MessagePayload
                    .error("Es gibt keine Aufgaben für den angefragten Schwierigkeitsgrad");
