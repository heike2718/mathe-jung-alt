...
public interface LaTeXDocGeneratorStrategy {
    ...
    /**
     * Generiert das LaTeX für ein vollständig expandiertes LaTex, in dem also
     * Fragen und Lösungen nicht importiert werden.
     *
     * @param aufgaben
     * @param raetselLaTeX
     ...
     * @return
     */
    String generateLaTeX(final List<Quizaufgabe> aufgaben, final List<RaetselLaTeXDto> raetselLaTeX,
