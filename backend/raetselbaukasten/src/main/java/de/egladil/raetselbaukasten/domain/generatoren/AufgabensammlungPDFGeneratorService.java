...
public class AufgabensammlungPDFGeneratorService {
    ...
    public GeneratedFile generate(final AufgabensammlungGeneratorInput input) {
        ...
        if (Verwendungszweck.LATEX == verwendungszweck) {
            ...
            throw new IllegalArgumentException(
                    "diese Methode funktioniert nicht für Verwendungszweck " + verwendungszweck);
        }
        ...
        String quellenverzeichnis = new QuellenverzeichnisLaTeXGenerator()
                .generiereQuellenverzeichnis(input.getAufgaben());

        template += quellenverzeichnis;

        String fileNameWithoutExtension = writeToDoc(template, aufgabensammlung.getUuid(), aufgabensammlung.getName(),
                verwendungszweck);
    ...
    String writeToDoc(final String template, final String aufgabensammlungID, final String aufgabensammlungName,
            final Verwendungszweck verwendungszweck) {
        ...
        try {
            ...
            if (message.isOk()) {
                ...
                if (pdf == null) {
                    ...
                    String msg = "Das generierte PDF zur Aufgabensammlung [fileNameWithoutExtension="
                            + fileNameWithoutExtension + ", aufgabensammlungID=" + aufgabensammlungID
            ...
            LOGGER
                    .error("Mist: generieren des PDFs hat nicht geklappt: fileNameWithoutExtension={} - {}",
                            fileNameWithoutExtension, message.getMessage());
            ...
            String msg = "Beim Generieren des Outputs " + Outputformat.PDF
                    + " zu Aufgabensammlung [fileNameWithoutExtension=" + fileNameWithoutExtension
