create table TEMP_RAETSELGRUPPEN as select * from RAETSELGRUPPEN;

create table TEMP_RAETSELGRUPPENELEMENTE as select * FROM RAETSELGRUPPENELEMENTE;

drop table RAETSELGRUPPENELEMENTE;
drop table RAETSELGRUPPEN;
drop view VW_AUFGABEN;
...
INSERT INTO RAETSELGRUPPEN select * from TEMP_RAETSELGRUPPEN;
INSERT INTO RAETSELGRUPPENELEMENTE select * from TEMP_RAETSELGRUPPENELEMENTE;

INSERT INTO DESKRIPTOREN (NAME, ADMIN, KONTEXT) VALUES ('frei', 1, 'RAETSEL');
