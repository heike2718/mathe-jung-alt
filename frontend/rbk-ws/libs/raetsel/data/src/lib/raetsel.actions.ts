import { FontName, GeneratedFile, GeneratedImages, LaTeXLayoutAntwortvorschlaege, Medienart, PageDefinition, Schriftgroesse } from '@rbk-ws/core/model';
import { EditRaetselPayload, GUIEditRaetselPayload, LinkedAufgabensammlung, MediumQuelleDto, RaetselDetails, RaetselsucheTreffer, RaetselSuchfilter } from '@rbk-ws/raetsel/model';
