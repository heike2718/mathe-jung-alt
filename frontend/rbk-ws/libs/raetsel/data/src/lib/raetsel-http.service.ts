...
export class RaetselHttpService {
  ...
  findRaetsel(
    admin: boolean,
    suchfilter: RaetselSuchfilter,
    pageDefinition: PageDefinition
  ): Observable<RaetselsucheTreffer> {
  ...
  findByMedienart(medienart: Medienart): Observable<MediumQuelleDto[]> {
    ...
    switch (medienart) {
      case 'BUCH':
        theMedienartStr = 'BUCH';
        break;
      case 'INTERNET':
        theMedienartStr = 'INTERNET';
        break;
      case 'ZEITSCHRIFT':
        theMedienartStr = 'ZEITSCHRIFT';
        break;
    }

    const params = new HttpParams().set('medienart', theMedienartStr);
