import { GeneratedImages, initialPaginationState, PaginationState, SelectableItem } from "@rbk-ws/core/model";
import { initialRaetselSuchfilter, Raetsel, RaetselDetails, RaetselSuchfilter, MediumQuelleDto, GUIEditRaetselPayload, createEditRaetselPayload, LinkedAufgabensammlung } from "@rbk-ws/raetsel/model";
