...
@Component({
  ...
  imports: [MatFormFieldModule, MatInputModule, SelectItemsComponent],
...
export class RaetselSuchfilterAdminComponent implements AfterViewInit, OnDestroy {
  ...
  @Output()
  private selectableItemsChanged: EventEmitter<SelectItemsComponentModel> =
    new EventEmitter<SelectItemsComponentModel>();

  ngAfterViewInit(): void {
    this.#inputSubscription = this.#raetselFacade.suchfilter$.subscribe(selectedSuchfilter => {
