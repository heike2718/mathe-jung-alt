...
const quelleEigenkreation = createSelector(selectMjaCoreAutorState, state => state.quelleEigenkreation);

const quelleEigenkreationLoaded = createSelector(selectMjaCoreAutorState, state => state.quelleEigenkreationLoaded);
