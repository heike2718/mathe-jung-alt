...
import { AnzahlabfrageErgebnis } from "@rbk-ws/core/model";
...
export class CoreStatistikEffects {
    ...
    loadAnzahlPublicRaetsel$ = createEffect(() => {
        ...
        return this.#actions.pipe(
            ...
            switchMap(() =>
                this.#httpClient.get<AnzahlabfrageErgebnis>('/raetselbaukasten/api/public/raetsel/anzahl/v1', { context: new HttpContext().set(SILENT_LOAD_CONTEXT, true) })
            ),
