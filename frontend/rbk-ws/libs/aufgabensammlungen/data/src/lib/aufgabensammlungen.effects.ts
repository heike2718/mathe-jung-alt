...
import { GeneratedFile } from '@rbk-ws/core/model';
import { FileDownloadService } from '@rbk-ws/shared/util';
...
export class AufgabensammlungenEffects {
  ...
  findAufgabensammlungen$ = createEffect(() => {
    return this.#actions.pipe(
      ...
      switchMap(action =>
        this.#aufgabensammlungenHttpService.findAufgabensammlungen(
          action.aufgabensammlungenSuchparameter,
          action.pageDefinition
        )
      ),
  ...
  selectAufgabensammlung$ = createEffect(() => {
    return this.#actions.pipe(
      ...
      map(aufgabensammlungDetails =>
        aufgabensammlungenActions.aUFGABENSAMMLUNGDETAILS_LOADED({
          aufgabensammlungDetails: aufgabensammlungDetails,
          navigateTo: 'aufgabensammlungen/details',
        })
      )
    );
  });
  ...
  saveAufgabensammlungselement$ = createEffect(() =>
    this.#actions.pipe(
      ...
      switchMap(action =>
        this.#aufgabensammlungenHttpService.saveAufgabensammlungselement(action.aufgabensammlungID, action.payload)
      ),
      map(aufgabensammlungDetails =>
        aufgabensammlungenActions.aUFGABENSAMMLUNGSELEMENTE_CHANGED({ aufgabensammlungDetails })
      )
    )
  );
  ...
  deleteAufgabensammlungselement$ = createEffect(() =>
    this.#actions.pipe(
      ...
      switchMap(action =>
        this.#aufgabensammlungenHttpService.deleteAufgabensammlungselement(action.aufgabensammlungID, action.payload)
      ),
      map(aufgabensammlungDetails =>
        aufgabensammlungenActions.aUFGABENSAMMLUNGSELEMENTE_CHANGED({ aufgabensammlungDetails })
      )
  ...
  generiereArbeitsblatt$ = createEffect(() =>
    this.#actions.pipe(
      ...
      switchMap(action =>
        this.#aufgabensammlungenHttpService.generiereArbeitsblattMitLoesungen(
          action.aufgabensammlungID,
          action.font,
          action.schriftgroesse,
          action.layoutAntwortvorschlaege
        )
      ),
  ...
  generiereKnobelkartei$ = createEffect(() =>
    this.#actions.pipe(
      ...
      switchMap(action =>
        this.#aufgabensammlungenHttpService.generiereKnobelkartei(
          action.aufgabensammlungID,
          action.font,
          action.schriftgroesse,
          action.layoutAntwortvorschlaege
  ...
  generiereVorschau$ = createEffect(() =>
    this.#actions.pipe(
      ...
      switchMap(action =>
        this.#aufgabensammlungenHttpService.generiereVorschau(
          action.aufgabensammlungID,
          action.font,
          action.schriftgroesse,
          action.layoutAntwortvorschlaege
  ...
  generiereLaTeX$ = createEffect(() =>
    this.#actions.pipe(
      ...
      switchMap(action =>
        this.#aufgabensammlungenHttpService.generiereLaTeX(
          action.aufgabensammlungID,
          action.font,
          action.schriftgroesse,
          action.layoutAntwortvorschlaege
