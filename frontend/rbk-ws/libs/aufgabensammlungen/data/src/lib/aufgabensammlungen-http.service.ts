...
import {
  ...
  QUERY_PARAM_LIMIT,
  QUERY_PARAM_OFFSET,
  QUERY_PARAM_SORT_ATTRIBUTE,
  QUERY_PARAM_SORT_DIRECTION,
  Schriftgroesse,
} from '@rbk-ws/core/model';
import { generateUUID } from '@rbk-ws/shared/util';
...
export class AufgabensammlungenHttpService {
  ...
  findAufgabensammlungen(
    suchparameter: AufgabensammlungenSuchparameter,
    pageDefinition: PageDefinition
  ): Observable<AufgabensammlungenTreffer> {
  ...
  saveAufgabensammlung(
    EditAufgabensammlungPayload: EditAufgabensammlungPayload
  ): Observable<AufgabensammlungBasisdaten> {
    const url = this.#url + '/v1';
  ...
  saveAufgabensammlungselement(
    aufgabensammlungID: string,
    payload: EditAufgabensammlungselementPayload
  ): Observable<AufgabensammlungDetails> {
  ...
  deleteAufgabensammlungselement(
    aufgabensammlungID: string,
    payload: Aufgabensammlungselement
  ): Observable<AufgabensammlungDetails> {
  ...
  generiereArbeitsblattMitLoesungen(
    aufgabensammlungID: string,
    font: FontName,
    schriftgroesse: Schriftgroesse,
    layoutAntwortvorschlaege: LaTeXLayoutAntwortvorschlaege
  ...
  #insertAufgabensammlungselement(
    url: string,
    payload: EditAufgabensammlungselementPayload
  ): Observable<AufgabensammlungDetails> {
    const headers = new HttpHeaders().set('Accept', 'application/json');
  ...
  #updateAufgabensammlungselement(
    url: string,
    payload: EditAufgabensammlungselementPayload
  ): Observable<AufgabensammlungDetails> {
    const headers = new HttpHeaders().set('Accept', 'application/json');
