...
import { FontName, GeneratedFile, LaTeXLayoutAntwortvorschlaege, PageDefinition, QUERY_PARAM_LIMIT, QUERY_PARAM_OFFSET, QUERY_PARAM_SORT_ATTRIBUTE, QUERY_PARAM_SORT_DIRECTION, Schriftgroesse } from "@rbk-ws/core/model";
