...
export const aufgabensammlungenActions = createActionGroup({
  ...
  events: {
    ...
    SAVE_AUFGABENSAMMLUNGSELEMENT: props<{
      aufgabensammlungID: string;
