import { GeneratedImages, initialPaginationState, PaginationState } from '@rbk-ws/core/model';
import {
...
export const aufgabensammlungenFeature = createFeature({
  ...
  reducer: createReducer(
    ...
    on(aufgabensammlungenActions.sUCHPARAMETER_CHANGED, (state, action) => ({
      ...state,
    ...
    on(aufgabensammlungenActions.aUFGABENSAMMLUNGDETAILS_LOADED, (state, action) => {
      return {
        ...state,
        aufgabensammlungDetails: action.aufgabensammlungDetails,
        aufgabensammlungBasisdaten: undefined,
      };
    }),
    ...
    on(aufgabensammlungenActions.aUFGABENSAMMLUNGSELEMENTE_CHANGED, (state, action) => ({
      ...state,
      aufgabensammlungDetails: action.aufgabensammlungDetails,
    })),
    on(aufgabensammlungenActions.sELECT_AUFGABENSAMMLUNGSELEMENT, (state, action) => ({
      ...state,
      selectedAufgabensammlungselement: action.aufgabensammlungselement,
    })),
    on(aufgabensammlungenActions.eLEMENT_IMAGES_LOADED, (state, action) => ({
      ...state,
      selectedElementImages: action.generatedImages,
    }))
  ),
});
