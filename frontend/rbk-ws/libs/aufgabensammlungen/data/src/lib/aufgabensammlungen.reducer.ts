...
import { AufgabensammlungBasisdaten, AufgabensammlungDetails, AufgabensammlungenSuchparameter, Aufgabensammlungselement, AufgabensammlungTrefferItem, initialAufgabensammlungenSuchparameter } from "@rbk-ws/aufgabensammlungen/model";
