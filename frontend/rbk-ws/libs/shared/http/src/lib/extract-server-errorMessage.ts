...
function getGenericMessageForStatus(status: number): Message {
  ...
  switch (status) {
    case 400:
      result = 'Payload oder Queryparameter haben Fehler';
      break;
    case 401:
      result = 'keine Berechtigung (401)';
      break;
    case 403:
      result = 'unerlaubte Aktion (403)';
      break;
    case 404:
      result = 'Das Objekt existiert nicht (404)';
      break;
    case 409:
      result = 'Speichern wegen eines Datenkonflikts nicht möglich';
      break;
    default:
      result = 'Im Backend ist ein unerwarteter Fehler aufgetreten.';
  }
