...
import { isValidFileName } from '@rbk-ws/shared/util';
...
export class SelectFileComponent implements OnInit {
  ...
  erlaubteDateinamenInfo =
    'Der Dateiname darf nur Ziffern, Buchstaben des deutschen Alphabets sowie die Zeichen Minus, Punkt und Unterstrich enthalten. Auch Leerzeichen sind nicht erlaubt.';
  ...
  errmFilename =
    'Der Name der gewählten Datei enthält ungültige Zeichen. Datei bitte umbenennen oder andere Datei auswählen.';
