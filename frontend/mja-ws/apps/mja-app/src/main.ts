...
import { coreDeskriptorenDataProvider, coreQuelleDataProvider, coreStatistikDataProvider } from '@mja-ws/core/api';
...
bootstrapApplication(AppComponent, {
  providers: [
    ...
    ),
    {
      ...
      useFactory: () => new Configuration(environment.baseUrl, environment.assetsPath, environment.withCredentials, 'mja-app'),
    },
