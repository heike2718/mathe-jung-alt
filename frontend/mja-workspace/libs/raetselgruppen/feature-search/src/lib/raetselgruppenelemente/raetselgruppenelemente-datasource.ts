 ...
 */
export class RaetselgruppenelementeDataSource extends DataSource<RaetselgruppenelementeItem> {
   ...
   */
   private getPagedData(data: RaetselgruppenelementeItem[]): RaetselgruppenelementeItem[] {
    if (this.paginator) {
