...
```
curl -X GET -i 'http://localhost:9200/latex2pdf?filename=test'
curl -X GET -i 'http://localhost:9200/latex2png?filename=test'
```

```
curl -X GET -i 'http://localhost:9200/latex2pdf?filename=test-fibel-nord'
curl -X GET -i 'http://localhost:9200/latex2png?filename=test-fibel-nord'
```

```
curl -X GET -i 'http://localhost:9200/latex2pdf?filename=test-fibel-sued'
curl -X GET -i 'http://localhost:9200/latex2png?filename=test-fibel-sued'
```

```
curl -X GET -i 'http://localhost:9200/latex2pdf?filename=test-druck-by-wok'
curl -X GET -i 'http://localhost:9200/latex2png?filename=test-druck-by-wok'
```
